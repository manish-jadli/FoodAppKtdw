          ...
          <SafeAreaView>
            <ScrollView
              ...
              <View style = {styles.container}>
                ...
                <Text style = {[styles.submitButtonText,styles.submit]}><Icon name="registered" size={20} color="#ffffff" /> Register</Text>
                </TouchableOpacity>

                <TouchableOpacity activeOpacity={0.8} style = {styles.submitButton} onPress = {() => this.props.navigation.navigate('Login')}>
