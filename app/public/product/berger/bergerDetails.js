...
import {
  ...
  export default function BergerDetails({navigation,route}){
   ...
   // render(){
    return(
                 ...
                 <View style = {styles.ourMenu}>
                   <View style={[styles.productHeader]}>
                    ...
                    {route.params.remaining >0 ? <Text style={[styles.header,styles.textGreen,styles.bbGreen,styles.mr15]}>Available</Text>:<Text style={[styles.header,styles.textRed,styles.bbRed,styles.mr15]}>Not Available</Text>}
                      ...
                      <Text>Total Price: <Text style={[styles.textGreen]}>Rs. {route.params.amount}</Text></Text>
        ...
        <View>
        {route.params.remaining >0 ?
        <TouchableOpacity style = {styles.submitButton} activeOpacity={0.8} onPress={()=>{navigation.navigate('Checkout')}}>
        ...
        <TouchableOpacity activeOpacity={0.8} style = {styles.submitButton} disabled={route.params.remaining === '0'} onPress={()=>{navigation.navigate('Payment',route)}}>
